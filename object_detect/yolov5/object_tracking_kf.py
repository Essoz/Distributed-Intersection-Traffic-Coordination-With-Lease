    ...
    for car in cars_angle:
        ...
        if dist_list:
            ...
            if len(dist_list) != 0:
                ...
                cars_position.append((np.cos(real_angle)*real_dist, np.sin(real_angle)*real_dist, np.tan(real_angle_l-real_angle_r)*real_dist))
        else:
